...
Aggregate command behavior and typed-result behavior are version 13 after
admitting a finite vocabulary of common named TeX mathematical symbols. Asset
...
version 3, and Structured content is version 6. The immediately previous
aggregate version 12 rejects instead of being reinterpreted.
...
escaped TeX special characters, common named symbols and relations, aligned row
and column separators, and matrix environments. Math-only alignment, script, and
row-break markers remain literal inside grouped text.
