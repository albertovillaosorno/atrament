...
Aggregate command behavior and typed-result behavior are version 20 after
admitting grouped mathematical alphabets. Asset reference, Ordering and
...
content is version 13. The immediately previous aggregate version 19 rejects
...
binomial coefficients, square roots, grouped mathematical alphabets, upright
unit or label groups, explicit `\text{...}` fragments, grouped custom operator
names, vector, overline, and underline decorations, escaped TeX special
