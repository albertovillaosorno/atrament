...
Aggregate command behavior and typed-result behavior are version 21 after
admitting common one-group TeX accents. Asset reference, Ordering and grouping,
...
14. The immediately previous aggregate version 20 rejects instead of being
reinterpreted.
