...
groups, scripts, fractions, binomial coefficients, square roots, upright unit or
label groups, grouped text, vector, overline, and underline decorations, escaped
TeX special characters, common named symbols, relations, operators, calculus,
set, and logic notation, aligned separators, and matrix environments. Unknown
control words and unadmitted control symbols remain explicit unsupported
