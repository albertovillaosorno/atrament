...
typed-result behavior are version 64 after admitting the standard parallel
control-symbol alias.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 52; Provenance and Style role are version 2.
