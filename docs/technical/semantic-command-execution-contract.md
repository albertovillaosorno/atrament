...
typed-result behavior are version 47 after admitting ordered TeX
brace-delimited-matrix environments. Asset reference, Ordering and
grouping, and Text content retain family behavior version 1; Document
constraint is version 3;
Structured content is version 40; Provenance and Style role are version 2.
