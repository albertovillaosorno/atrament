...
typed-result behavior are version 88 after admitting the core plain-TeX
`\surd` glyph as exact source.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 76; Provenance and Style role are version 2.
