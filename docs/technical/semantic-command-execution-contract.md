...
typed-result behavior are version 11 after making grouped mathematical text
opaque to math-only structural markers. Asset reference, Ordering and grouping,
and Text content retain family behavior version 1; Document constraint is
version 3; Structured content is version 4; Provenance and Style role are
version 2.
