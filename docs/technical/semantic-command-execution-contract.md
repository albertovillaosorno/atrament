...
typed-result behavior are version 44 after admitting ordered TeX
bracketed-matrix environments. Asset reference, Ordering and grouping, and
Text content retain family behavior version 1; Document constraint is version 3;
Structured content is version 37; Provenance and Style role are version 2.
