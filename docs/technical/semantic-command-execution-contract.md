...
typed-result behavior are version 94 after admitting LaTeX-base math-mode glyph
aliases as exact source. Asset reference, Ordering and grouping, and
Text content retain family behavior version 1; Document constraint is version 3;
Structured content
is version 82; Provenance and Style role are version 2.
