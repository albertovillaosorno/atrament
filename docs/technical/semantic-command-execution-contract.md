...
typed-result behavior are version 43 after admitting indexed TeX square
roots. Asset reference, Ordering and grouping, and
Text content retain family behavior version 1; Document constraint is version 3;
Structured content is version 36; Provenance and Style role are version 2.
