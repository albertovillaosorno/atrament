...
typed-result behavior are version 24 after admitting variant Greek TeX symbols.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3; Structured content is version 17;
