...
typed-result behavior are version 77 after admitting exact-source AMS geometric
ordinary symbols.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 65; Provenance and Style role are version 2.
