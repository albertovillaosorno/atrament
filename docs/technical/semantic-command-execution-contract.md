...
typed-result behavior are version 65 after broadening exact-source harpoon and
mapped-arrow admission.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 53; Provenance and Style role are version 2.
