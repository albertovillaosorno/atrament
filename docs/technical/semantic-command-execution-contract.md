...
typed-result behavior are version 89 after admitting the remaining standalone
AMS special symbols and large box/diamond aliases as exact source. Asset
reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3; Structured content is version 77;
