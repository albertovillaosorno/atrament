...
typed-result behavior are version 48 after admitting ordered TeX small-matrix
environments. Asset reference, Ordering and
grouping, and Text content retain family behavior version 1; Document
constraint is version 3;
Structured content is version 41; Provenance and Style role are version 2.
