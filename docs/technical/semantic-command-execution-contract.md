...
typed-result behavior are version 79 after admitting exact-source AMS order,
equality, and approximation relations.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 67; Provenance and Style role are version 2.
