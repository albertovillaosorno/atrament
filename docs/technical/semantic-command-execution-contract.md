...
typed-result behavior are version 15 after admitting common calculus operators,
symbols, and limit arrows. Asset reference, Ordering and grouping, and Text
content retain family behavior version 1; Document constraint is version 3;
Structured content is version 8; Provenance and Style role are version 2.
