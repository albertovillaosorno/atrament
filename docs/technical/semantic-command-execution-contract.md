...
typed-result behavior are version 16 after admitting grouped vector, overline,
and underline decorations. Asset reference, Ordering and grouping, and Text
content retain family behavior version 1; Document constraint is version 3;
Structured content is version 9; Provenance and Style role are version 2.
