...
typed-result behavior are version 17 after admitting common set, logic,
membership, containment, and arrow notation. Asset reference, Ordering and
grouping, and Text content retain family behavior version 1; Document constraint
is version 3; Structured content is version 10; Provenance and Style role are
version 2.
