...
typed-result behavior are version 80 after admitting exact-source positive AMS
arrow relations.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 68; Provenance and Style role are version 2.
