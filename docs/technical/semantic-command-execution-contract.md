...
typed-result behavior are version 81 after admitting exact-source AMS triangle
and strong-containment relations.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 69; Provenance and Style role are version 2.
