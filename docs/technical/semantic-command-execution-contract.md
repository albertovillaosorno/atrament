...
typed-result behavior are version 68 after broadening exact-source LaTeX-base
ordinary-symbol admission.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 56; Provenance and Style role are version 2.
