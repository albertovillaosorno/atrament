...
typed-result behavior are version 62 after broadening exact-source
foundational named-symbol admission.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 50; Provenance and Style role are version 2.
