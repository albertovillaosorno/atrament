...
typed-result behavior are version 22 after completing the standard Greek TeX
control-sequence vocabulary. Asset reference, Ordering and grouping, and Text
content retain family behavior version 1; Document constraint is version 3;
Structured content is version 15; Provenance and Style role are version 2.
