...
typed-result behavior are version 32 after admitting explicit display- and
text-style TeX fractions. Asset reference, Ordering and grouping, and Text
content retain family behavior version 1; Document constraint is version 3;
Structured content is version 25; Provenance and Style role are version 2.
