...
typed-result behavior are version 63 after broadening exact-source standard
operator and relation admission.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 51; Provenance and Style role are version 2.
