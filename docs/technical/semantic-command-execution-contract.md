...
typed-result behavior are version 67 after broadening exact-source mathematical
punctuation and integral-operator atom admission.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 55; Provenance and Style role are version 2.
