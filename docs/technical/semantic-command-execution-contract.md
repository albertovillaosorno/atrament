...
typed-result behavior are version 45 after admitting ordered TeX
vertical-bar-matrix environments. Asset reference, Ordering and grouping, and
Text content retain family behavior version 1; Document constraint is version 3;
Structured content is version 38; Provenance and Style role are version 2.
