...
typed-result behavior are version 39 after rejecting TeX environments that
remain active across their owning group close. Asset reference, Ordering
and grouping, and Text content retain
family behavior version 1; Document constraint is version 3; Structured content
is version 32; Provenance and Style role are version 2.
