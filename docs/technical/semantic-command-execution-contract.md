...
typed-result behavior are version 10 after admitting grouped text fragments
inside mathematics. Asset reference, Ordering and grouping, and Text content
retain family behavior version 1; Document constraint and Structured content are
version 3; Provenance and Style role are version 2.
