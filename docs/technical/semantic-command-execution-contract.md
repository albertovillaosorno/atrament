...
typed-result behavior are version 74 after admitting exact-source fourfold
integral, reverse implication, and vertical-bar delimiter spellings.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 62; Provenance and Style role are version 2.
