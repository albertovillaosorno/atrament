...
typed-result behavior are version 82 after completing the exact-source positive
AMS relation declarations except the strict square-subset spellings.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 70; Provenance and Style role are version 2.
