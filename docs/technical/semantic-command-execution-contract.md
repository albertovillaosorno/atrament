...
typed-result behavior are version 78 after admitting the complete exact-source
AMS binary-operator declaration set.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 66; Provenance and Style role are version 2.
