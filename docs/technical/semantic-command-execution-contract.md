...
typed-result behavior are version 75 after admitting the exact grouped
parenthesized modular-operand form.
Asset reference, Ordering and grouping, and Text content retain family behavior
version 1; Document constraint is version 3;
Structured content is version 63; Provenance and Style role are version 2.
