...
typed-result behavior are version 97 after admitting the LaTeX-base fixed math
ellipsis alias. Asset reference, Ordering and grouping, and Text content retain
family behavior version 1; Document constraint is version 3; Structured content
is version 84; Provenance and Style role are version 2.
