...
typed-result behavior are version 23 after admitting common relation and logic
TeX symbols. Asset reference, Ordering and grouping, and Text content retain
family behavior version 1; Document constraint is version 3; Structured content
is version 16; Provenance and Style role are version 2.
