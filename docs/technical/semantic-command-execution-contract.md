...
typed-result behavior are version 31 after admitting grouped TeX stacked
annotations. Asset reference, Ordering and grouping, and Text content retain
family behavior version 1; Document constraint is version 3; Structured content
is version 24; Provenance and Style role are version 2.
