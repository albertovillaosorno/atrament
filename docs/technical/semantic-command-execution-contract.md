...
typed-result behavior are version 20 after admitting grouped mathematical
alphabets. Asset reference, Ordering and grouping, and Text content retain
family behavior version 1; Document constraint is version 3; Structured content
is version 13; Provenance and Style role are version 2.
