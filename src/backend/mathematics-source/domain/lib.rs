...
const NAMED_SYMBOL_COMMANDS: &[&str] = &[
    ...
    "\\asymp", "\\backslash",
    "\\because", "\\beta", "\\beth", "\\bigcirc", "\\bigtriangledown",
    "\\bigtriangleup", "\\bot", "\\bowtie", "\\bullet", "\\cap", "\\cdot",
    "\\cdotp", "\\cdots", "\\chi", "\\circ", "\\clubsuit", "\\colon",
    "\\cong",
    ...
    "\\longmapsto", "\\longrightarrow", "\\lor", "\\lvert", "\\mapsto",
    "\\mathdollar",
    "\\mathparagraph", "\\mathsection", "\\mho", "\\mid", "\\models", "\\mp",
    "\\mu", "\\nabla", "\\natural", "\\ne", "\\nearrow", "\\neg",
    "\\neq", "\\nexists",
    "\\ni", "\\notin", "\\nu", "\\nwarrow", "\\odot", "\\omega",
    "\\ominus", "\\oplus",
    ...
    "\\sigma",
    "\\sim", "\\simeq", "\\smile", "\\spadesuit", "\\sqcap", "\\sqcup",
    "\\sqsubseteq",
