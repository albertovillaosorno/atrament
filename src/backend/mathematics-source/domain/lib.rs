...
const NAMED_SYMBOL_COMMANDS: &[&str] = &[
    ...
    "\\approxeq", "\\ast",
    "\\asymp", "\\backsim", "\\backsimeq", "\\backslash", "\\barwedge",
    "\\because", "\\beta", "\\beth", "\\bigcirc", "\\bigstar",
    "\\bigtriangledown",
    "\\bigtriangleup", "\\blacklozenge", "\\blacksquare", "\\blacktriangle",
    "\\blacktriangledown", "\\bot", "\\bowtie", "\\boxdot", "\\boxminus",
    ...
    "\\lfloor", "\\ll", "\\lnot", "\\longleftarrow", "\\longleftrightarrow",
    ...
    "\\rvert",
    "\\searrow", "\\setminus", "\\sharp",
    "\\sigma",
    "\\sim", "\\simeq", "\\smallsetminus", "\\smile", "\\spadesuit",
    "\\sphericalangle",
    "\\sqcap", "\\sqcup",
    "\\sqsubseteq",
    ...
    "\\supset", "\\supseteq", "\\supsetneq", "\\swarrow",
    "\\tau", "\\therefore", "\\theta", "\\thickapprox", "\\thicksim", "\\times",
    "\\to", "\\top",
    "\\triangle", "\\triangledown", "\\triangleleft", "\\triangleq",
    "\\triangleright", "\\twoheadleftarrow", "\\twoheadrightarrow", "\\uparrow",
