...
const NAMED_SYMBOL_COMMANDS: &[&str] = &[
    "\\Bbbk", "\\Cap", "\\Cup", "\\Delta", "\\Downarrow", "\\Finv",
    "\\Game", "\\Gamma",
    "\\Im", "\\Lambda", "\\Leftarrow",
    ...
    "\\Xi", "\\aleph", "\\alpha", "\\amalg", "\\angle", "\\approx", "\\ast",
    "\\asymp", "\\backslash", "\\barwedge",
    ...
    "\\boxplus", "\\boxtimes", "\\bullet", "\\cap", "\\cdot",
    "\\cdotp", "\\cdots", "\\centerdot", "\\chi", "\\circ", "\\circledS",
    "\\circledast", "\\circledcirc", "\\circleddash",
    "\\clubsuit", "\\colon",
    "\\cong",
    "\\cup", "\\curlyvee", "\\curlywedge", "\\dagger", "\\daleth",
    "\\dashv", "\\ddagger", "\\ddots",
    "\\delta", "\\diagdown", "\\diagup",
    "\\diamond", "\\diamondsuit", "\\digamma", "\\div", "\\divideontimes",
    "\\doteq", "\\dotplus",
    "\\dots", "\\doublebarwedge", "\\downarrow",
    "\\ell", "\\emptyset", "\\epsilon", "\\equiv", "\\eta", "\\eth",
    "\\exists",
    "\\flat", "\\forall", "\\frown", "\\gamma", "\\ge", "\\geq", "\\geqslant",
    "\\gets", "\\gg", "\\gimel",
    "\\gtrdot", "\\gtrsim", "\\hbar", "\\heartsuit", "\\hookleftarrow",
    ...
    "\\preceq", "\\prime", "\\propto", "\\psi", "\\rVert", "\\rangle",
    "\\rbrace",
    "\\rbrack", "\\rceil",
    "\\rfloor", "\\rho", "\\rightarrow", "\\rightharpoondown",
    "\\rightharpoonup",
    "\\rightleftharpoons", "\\rightthreetimes", "\\rtimes", "\\rvert",
    ...
    "\\triangle", "\\triangledown", "\\triangleleft",
