...
const NAMED_OPERATOR_COMMANDS: &[&str] = &[
    ...
    "\\bigodot", "\\bigoplus", "\\bigotimes", "\\bigsqcup", "\\bmod", "\\cos",
...
const NAMED_SYMBOL_COMMANDS: &[&str] = &[
    ...
    "\\forall", "\\frown", "\\gamma", "\\ge", "\\geq", "\\geqslant",
    "\\gets", "\\gg",
    ...
    "\\rightharpoonup",
    "\\rightleftharpoons", "\\searrow", "\\setminus", "\\sigma",
    "\\sim", "\\simeq", "\\smile", "\\sqcap", "\\sqcup", "\\sqsubseteq",
