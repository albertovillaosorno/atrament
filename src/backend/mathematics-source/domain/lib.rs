...
const NAMED_SYMBOL_COMMANDS: &[&str] = &[
    "\\Bbbk", "\\Delta", "\\Downarrow", "\\Finv", "\\Game", "\\Gamma",
    "\\Im", "\\Lambda", "\\Leftarrow",
    ...
    "\\blacktriangledown", "\\bot", "\\bowtie", "\\bullet", "\\cap", "\\cdot",
    "\\cdotp", "\\cdots", "\\chi", "\\circ", "\\circledS",
    "\\clubsuit", "\\colon",
    "\\cong",
    "\\cup", "\\dagger", "\\daleth", "\\dashv", "\\ddagger", "\\ddots",
    "\\delta", "\\diagdown", "\\diagup",
    "\\diamond", "\\diamondsuit", "\\digamma", "\\div", "\\doteq",
    "\\dots", "\\downarrow",
    "\\ell", "\\emptyset", "\\epsilon", "\\equiv", "\\eta", "\\eth",
    "\\exists",
    "\\flat", "\\forall", "\\frown", "\\gamma", "\\ge", "\\geq", "\\geqslant",
    "\\gets", "\\gg", "\\gimel",
    "\\gtrsim", "\\hbar", "\\heartsuit", "\\hookleftarrow",
    "\\hookrightarrow", "\\hslash", "\\iff",
    "\\imath", "\\impliedby", "\\implies", "\\in", "\\infty", "\\iota",
    "\\jmath", "\\kappa", "\\lVert",
    "\\lambda", "\\land", "\\langle", "\\lbrace", "\\lbrack", "\\lceil",
    "\\ldotp", "\\ldots", "\\le", "\\leadsto",
    "\\leftarrow", "\\leftharpoondown", "\\leftharpoonup", "\\leftrightarrow",
    "\\leq", "\\leqslant", "\\lesssim",
    "\\lfloor", "\\ll", "\\lnot", "\\longleftarrow", "\\longleftrightarrow",
    "\\longmapsto", "\\longrightarrow", "\\lor", "\\lozenge", "\\lvert",
    "\\mapsto",
    "\\mathdollar",
    ...
    "\\rightharpoonup",
    "\\rightleftharpoons", "\\rvert", "\\searrow", "\\setminus", "\\sharp",
    "\\sigma",
    "\\sim", "\\simeq", "\\smile", "\\spadesuit", "\\sphericalangle",
    "\\sqcap", "\\sqcup",
    "\\sqsubseteq",
