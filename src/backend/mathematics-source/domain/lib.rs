...
const NAMED_SYMBOL_COMMANDS: &[&str] = &[
    ...
    "\\cdot", "\\chi", "\\circ", "\\cong", "\\cup", "\\delta", "\\div",
    "\\downarrow", "\\emptyset", "\\epsilon", "\\equiv", "\\eta", "\\exists",
    "\\forall", "\\gamma", "\\ge", "\\geq", "\\hookleftarrow",
    "\\hookrightarrow", "\\in", "\\infty", "\\iota", "\\kappa", "\\lambda",
    "\\land", "\\langle", "\\lbrace", "\\lceil", "\\le", "\\leftarrow",
    "\\leftrightarrow", "\\leq", "\\lfloor", "\\longleftarrow",
    "\\longleftrightarrow", "\\longrightarrow", "\\lor", "\\mapsto", "\\mid",
    "\\mp", "\\mu", "\\nabla", "\\ne", "\\nearrow", "\\neg", "\\neq",
    "\\notin", "\\nu", "\\nwarrow", "\\omega", "\\oplus", "\\otimes",
    "\\parallel", "\\partial", "\\perp", "\\phi", "\\pi", "\\pm", "\\propto",
    "\\psi", "\\rangle", "\\rbrace", "\\rceil", "\\rfloor", "\\rho",
    "\\rightarrow", "\\searrow", "\\setminus", "\\sigma", "\\sim", "\\star",
    "\\subset", "\\subseteq", "\\supset", "\\supseteq", "\\swarrow", "\\tau",
    "\\theta", "\\times", "\\to", "\\uparrow", "\\updownarrow", "\\upsilon",
    "\\varepsilon", "\\varphi", "\\varpi", "\\varrho", "\\varsigma",
    "\\vartheta", "\\vee", "\\vert", "\\wedge", "\\xi", "\\zeta",
];
