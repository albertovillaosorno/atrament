...
const NAMED_SYMBOL_COMMANDS: &[&str] = &[
    ...
    "\\dots", "\\doublebarwedge", "\\doublecap", "\\doublecup", "\\downarrow",
    "\\downdownarrows",
    ...
    "\\geqslant",
    "\\gets", "\\gg", "\\ggg", "\\gggtr", "\\gimel", "\\gnapprox", "\\gneq",
    "\\gneqq",
    "\\gnsim", "\\gtrapprox",
    ...
    "\\lfloor", "\\lhd", "\\ll", "\\llcorner", "\\lll", "\\llless",
    "\\lnapprox",
    "\\lneq",
    "\\lneqq", "\\lnot",
    "\\lnsim", "\\longleftarrow",
    ...
    "\\rangle",
    "\\rbrace",
    "\\rbrack", "\\rceil", "\\restriction",
    "\\rfloor", "\\rhd", "\\rho", "\\rightarrow", "\\rightarrowtail",
    "\\rightharpoondown",
    ...
    "\\twoheadrightarrow", "\\ulcorner", "\\unlhd", "\\unrhd", "\\uparrow",
    "\\updownarrow", "\\upharpoonleft", "\\upharpoonright", "\\uplus",
    "\\upsilon", "\\upuparrows", "\\urcorner", "\\vDash",
    ...
    "\\varpi", "\\varpropto", "\\varrho", "\\varsigma", "\\varsubsetneq",
