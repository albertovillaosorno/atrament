...
const NAMED_SYMBOL_COMMANDS: &[&str] = &[
    ...
    "\\Xi", "\\aleph", "\\alpha", "\\angle", "\\approx", "\\ast", "\\backslash",
    "\\because", "\\beta", "\\bot",
    "\\bullet", "\\cap", "\\cdot", "\\cdots", "\\chi", "\\circ", "\\cong",
    "\\cup", "\\dashv", "\\ddots", "\\delta", "\\diamond", "\\div",
    "\\dots", "\\downarrow",
