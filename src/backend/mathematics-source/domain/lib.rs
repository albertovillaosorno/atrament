...
const NAMED_OPERATOR_COMMANDS: &[&str] = &[
    ...
    "\\dim", "\\exp", "\\gcd", "\\hom", "\\iiiint", "\\iiint", "\\iint",
    "\\inf",
...
const NAMED_SYMBOL_COMMANDS: &[&str] = &[
    ...
    "\\Longleftrightarrow",
    "\\Longrightarrow", "\\Lsh", "\\Omega", "\\Phi", "\\Pi", "\\Psi", "\\Re",
    "\\Rightarrow", "\\Rrightarrow", "\\Rsh",
    "\\Sigma", "\\Subset", "\\Supset", "\\Theta", "\\Uparrow", "\\Updownarrow",
    "\\Upsilon", "\\Vdash", "\\Vert", "\\Vvdash",
    "\\Xi", "\\aleph", "\\alpha", "\\amalg", "\\angle", "\\approx",
    "\\approxeq", "\\ast",
    "\\asymp", "\\backepsilon", "\\backsim", "\\backsimeq", "\\backslash",
    "\\barwedge",
    "\\because", "\\beta", "\\beth", "\\between", "\\bigcirc", "\\bigstar",
    "\\bigtriangledown",
    ...
    "\\dagger", "\\daleth",
    "\\dashv", "\\ddagger", "\\ddots",
    "\\delta", "\\diagdown", "\\diagup",
    "\\diamond", "\\diamondsuit", "\\digamma", "\\div", "\\divideontimes",
    "\\doteq", "\\doteqdot", "\\dotplus",
    "\\dots", "\\doublebarwedge", "\\downarrow", "\\downdownarrows",
    "\\downharpoonleft", "\\downharpoonright",
    "\\ell", "\\emptyset", "\\epsilon", "\\eqcirc", "\\eqsim", "\\eqslantgtr",
    "\\eqslantless", "\\equiv", "\\eta", "\\eth",
    "\\exists", "\\fallingdotseq",
    "\\flat", "\\forall", "\\frown", "\\gamma", "\\ge", "\\geq", "\\geqq",
    "\\geqslant",
    "\\gets", "\\gg", "\\ggg", "\\gimel", "\\gtrapprox",
    "\\gtrdot", "\\gtreqless", "\\gtreqqless", "\\gtrless", "\\gtrsim",
    "\\hbar", "\\heartsuit", "\\hookleftarrow",
    "\\hookrightarrow", "\\hslash", "\\iff",
    "\\imath", "\\impliedby", "\\implies", "\\in", "\\infty", "\\intercal",
    "\\iota",
    "\\jmath", "\\kappa", "\\lVert",
    "\\lambda", "\\land", "\\langle", "\\lbrace", "\\lbrack", "\\lceil",
    "\\ldotp", "\\ldots", "\\le", "\\leadsto",
    ...
    "\\leftthreetimes",
    "\\leq", "\\leqq", "\\leqslant", "\\lessapprox", "\\lessdot", "\\lesseqgtr",
    "\\lesseqqgtr", "\\lessgtr", "\\lesssim",
    "\\lfloor", "\\ll", "\\lll", "\\lnot", "\\longleftarrow",
    "\\longleftrightarrow",
    ...
    "\\preceq", "\\precsim", "\\prime", "\\propto", "\\psi", "\\rVert",
    "\\rangle",
    "\\rbrace",
    "\\rbrack", "\\rceil",
    "\\rfloor", "\\rho", "\\rightarrow", "\\rightarrowtail",
    "\\rightharpoondown",
    "\\rightharpoonup", "\\rightleftarrows",
    "\\rightleftharpoons", "\\rightrightarrows", "\\rightsquigarrow",
    "\\rightthreetimes", "\\risingdotseq", "\\rtimes",
    "\\rvert",
    "\\searrow", "\\setminus", "\\sharp", "\\shortmid", "\\shortparallel",
    "\\sigma",
    "\\sim", "\\simeq", "\\smallfrown", "\\smallsetminus", "\\smallsmile",
    "\\smile", "\\spadesuit",
    "\\sphericalangle",
    "\\sqcap", "\\sqcup",
    "\\sqsubseteq",
    "\\sqsupseteq", "\\square", "\\star", "\\subset", "\\subseteq",
    "\\subseteqq",
    "\\subsetneq",
    "\\succ", "\\succapprox", "\\succcurlyeq", "\\succeq", "\\succsim",
    "\\supset", "\\supseteq", "\\supseteqq", "\\supsetneq", "\\swarrow",
    ...
    "\\twoheadrightarrow", "\\uparrow",
    "\\updownarrow", "\\upharpoonleft", "\\upharpoonright", "\\uplus",
    "\\upsilon", "\\upuparrows", "\\vDash",
    ...
    "\\varkappa", "\\varnothing", "\\varphi",
    "\\varpi", "\\varpropto", "\\varrho", "\\varsigma", "\\vartheta",
    "\\vartriangle",
