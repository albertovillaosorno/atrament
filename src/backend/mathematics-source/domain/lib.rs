...
const NAMED_SYMBOL_COMMANDS: &[&str] = &[
    ...
    "\\Vert", "\\Xi", "\\alpha", "\\approx", "\\ast", "\\beta", "\\bullet",
    "\\cap", "\\cdot", "\\chi", "\\circ", "\\cong", "\\cup", "\\delta",
    "\\div", "\\emptyset", "\\epsilon", "\\equiv", "\\eta", "\\exists",
    "\\forall", "\\gamma", "\\ge", "\\geq", "\\in", "\\infty", "\\iota",
    "\\kappa", "\\lambda", "\\land", "\\langle", "\\lbrace", "\\lceil",
    "\\le", "\\leftarrow", "\\leq", "\\lfloor", "\\lor", "\\mid", "\\mp",
    "\\mu", "\\nabla", "\\ne", "\\neg", "\\neq", "\\notin", "\\nu", "\\omega",
    "\\oplus", "\\otimes", "\\parallel", "\\partial", "\\perp", "\\phi",
    "\\pi", "\\pm", "\\propto", "\\psi", "\\rangle", "\\rbrace", "\\rceil",
    "\\rfloor", "\\rho", "\\rightarrow", "\\setminus", "\\sigma", "\\sim",
    "\\star", "\\subset", "\\subseteq", "\\supset", "\\supseteq", "\\tau",
    "\\theta", "\\times", "\\to", "\\upsilon", "\\varepsilon", "\\varphi",
    "\\varpi", "\\varrho", "\\varsigma", "\\vartheta", "\\vee", "\\vert",
    "\\wedge", "\\xi", "\\zeta",
];
