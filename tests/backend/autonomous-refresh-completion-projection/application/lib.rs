...
// Boundary-Contract:
// - Owns:
//   - Exhaustive evidence for refreshed stale/context completion projection.
// - Must-Not:
//   - Refresh state, rebase batches, infer satisfaction, retry, mutate, or run
//     loops.
// - Allows:
...
//   - Side effects: None.
// - Split-When:
//   - Stateful refresh fixtures gain independent execution evidence.
// - Merge-When:
//   - Coordinator tests fully subsume this finite projection oracle.
// - Summary:
//   - Proves only refreshed stale/context results can complete here.
// - Description:
...
// - Defaults:
//   - Every unrelated result stays nonterminal on this projection.
//
...
use atrament_autonomous_refresh_completion_projection::
    autonomous_refreshed_state_completion_terminal_outcome;
...
#[test]
fn all_90_refreshed_completion_combinations_match_frozen_contract() {
